...
const isActiveRoute = computed(() => {
  const activeRouteNames = ['StreetsIndexView', 'StreetsCreateView', 'StreetsEditView', 'StreetsHouseholdsView', 'HouseholdsCreateView', 'HouseholdsEditView', 'ResidentsIndexView', 'ResidentsCreateView'];
  ...
  <div class="page">
    ...
    <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
      <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark my-3">
          <a href=".">
            Logo
          </a>
        </h1>
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
              <span class="avatar avatar-sm"
                style="background-image: url(https://static.vecteezy.com/system/resources/previews/000/439/863/original/vector-users-icon.jpg)"></span>
          ...
          <ul class="navbar-nav pt-lg-3">
            ...
            <li class="nav-item py-1">
              <RouterLink class="nav-link" :to="{ name: 'home' }">
                <span
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chart-dots-3" width="24"
            ...
            <li class="nav-item py-1">
              <RouterLink class="nav-link" :to="{ name: 'home' }">
                <span
                  class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-speakerphone" width="24"
                    height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <li class="nav-item py-1" :class="{ active: isActiveRoute }">
              <RouterLink class="nav-link" :to="{ name: 'StreetsIndexView' }">
                <span
                  class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
